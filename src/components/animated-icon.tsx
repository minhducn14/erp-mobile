...
export function AnimatedIcon() {
  return (
    <View className="justify-center items-center w-[128px] h-[128px] z-50">
      ...
      <Animated.View entering={keyframe.duration(DURATION)} className="w-[128px] h-[128px] absolute rounded-[40px] bg-gradient-to-b from-[#3C9FFE] to-[#0274DF]" />
